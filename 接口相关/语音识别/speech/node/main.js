...
let client = new AipSpeech(0, 'lGMnb8SpzgjoFvbFpFI2O3ss', 'BbkG7ggKV03spm2NOaa6HlONQD7jGl6T');

let voice = fs.readFileSync(path.join(__dirname, '../assets/-1VR02YsKOIx_CY-MQ9lB2cV.wav'));
...
//     'http://bos.nj.bpc.baidu.com/v1/audio/8k.amr', 
//     'http://yq01-ecom-holmes22-20150818112825.yq01.baidu.com:8492/aip/dump', 'amr', 8000)
